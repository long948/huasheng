  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        prop="price"
      />
      <el-table-column label="是否正在站岗" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.is_stand_guard == 0">否</span>
          <span v-else>是</span>
        </template>
      </el-table-column>
      <el-table-column label="是否在休息" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.is_defense == 0">否</span>
          <span v-else>是</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="站岗后是否需要休息" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.is_defense_interval == 0">否</span>
          <span v-else>是</span>
        </template>
      </el-table-column>

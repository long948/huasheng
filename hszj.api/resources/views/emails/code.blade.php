        ...
        <div class="contaner">
            ...
            <div class="content">
                ...
                <div class="xboxcontent">
                    <div class="neirong">
                        <p><b>您的验证码是：</b><span class="font_lightblue"><span id="yzm" data="$(captcha)" onclick="return false;" t="7" style="border-bottom: 1px dashed rgb(204, 204, 204); z-index: 1; position: static;">{{$code}}</span></span><br>
                        <span class="font_gray">(请输入该验证码完成注册，验证码30分钟内有效！)</span></p>
                        <div class="line">如果你未进行注册，请忽略该邮件。</div>
                    </div>
                </div>

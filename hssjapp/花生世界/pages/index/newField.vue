	...
	<view class="w-100">
		...
		<scroll-view class="box" scroll-y="true">
			<view class="farm-content">
				...
				<!-- 逍遥王土地入口 -->
				<view class="newField" @click="app.goBack()">
					<image mode="widthFix" src="../../static/img/a94b49101d5dec0ba7a43137c51a2a0.png"></image>
				</view>
				<view class="handle-cont">
					<view class="w-100 flex-center flex-j-center mt-20">
						<view class="button-cont button-shares" @click="app.showOpen('Shopping/index')">
							<view class="pic">
								<image mode="widthFix" src="../../static/img/36e8da26d0f9d5708ba7f30b08ec5b7.png"></image>
							</view>
							<view class="text text-center font-12">兑换</view>
						</view>
					</view>
					<view class="w-100 flex-center flex-j-center mt-20">
						<view class="button-cont button-shares" @click="app.showOpenTab('store/store')">
							<view class="pic">
								<image mode="widthFix" src="../../static/img/c2e1e94acf4a0800359054140ca13de.png"></image>
							</view>
							<view class="text text-center font-12">拼土地</view>
						</view>
					</view>
					<view class="w-100 flex-center flex-j-center mt-20">
					...
					<view class="w-100 flex-center flex-j-center mt-20">
						<view class="button-cont button-share" @click="goShare()">
							...
							<view class="text text-center font-12" style="bottom: 2px;">分享</view>
						</view>
					</view>
				</view>
				<!-- 我的田地 -->
...
<style>
	...
	.newField{
		position: absolute;bottom: 15px;right: 100px;z-index: 10;
	}
	.newField image{
		width: 80px;height: 80px;
	}
	.handle-cont .button-cont{
		width: 55px;
		height: 65px;
	}
	.handle-cont .button-cont .text{
		height: 15px;
		line-height: 15px;
		font-size: 8px;

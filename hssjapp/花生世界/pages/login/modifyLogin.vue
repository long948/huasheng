	...
	<view class="box">
		<view class="w-100 bc-white pt-10">
			<view class="contInput bt_line">
				<input type="password" :placeholder="lang.mdl1" v-model="old" maxlength="20" />
			</view>
			<view class="contInput bt_line">
				<input type="password" :placeholder="lang.mdl2" v-model="pass" maxlength="20" />
			</view>
			<view class="contInput bt_line">
				<input type="password" :placeholder="lang.mdl3" v-model="pass1" maxlength="20" />
			</view>
			<view class="contInput flex-center pr-20">
				<input type="text" :placeholder="lang.mdl4" v-model="code" maxlength="6" />
				<view class="one-row">
	...
	export default {
		...
		methods: {
			modifyPass:function(){
				...
				user.modifyLogin(send,function(res){
